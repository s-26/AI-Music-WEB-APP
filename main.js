...
function preload() {
    song=loadSound("20211013_114527.mp3");
    song2=loadSound("20211013_120921.mp3");
}
...
function draw() {
    ...
    if(score_left_wrist>0.2) {
        ...
        if(song1_status==false) {
            play();
            song.isPlaying();
            document.getElementById("song_name").innerHTML="Playing= SAATVIK's VEENA PERFORMANCE 1";
        }
    }
    ...
    if(score_right_wrist>0.2) {
        ...
        if(song2_status==false) {
            play2();
            song2.isPlaying();
            document.getElementById("song_name").innerHTML="Playing= SAATVIK's VEENA PERFORMANCE 2";
        }
    }
}
